...
return (
    <>
    {props.info ? (
        <section className="collapse_section" key={props.info.id}>
        ...
        <div className="collapses" key={props.prod.id}>
                ...
                <div className="collapse_description_log">
                    <ul className="list_equipment">
                        {props.prod.equipments.map((equip, index) => (
                            visible && <li key={index} className="info_description_log_equip">{equip}</li>
                        ))}
                    </ul>
                </div>
            </section>
